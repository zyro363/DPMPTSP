...
<div class="min-height-200px">
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-list"></i> Data Layanan</h2>
         </div>
         <div class="pull-right">
            <a href="/admin/layanan/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
         </div>
      </div>
      <hr>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td class="text-center" width="20%">
                  <a href="/admin/layanan/detail/{{$row->id}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                  <a href="/admin/layanan/edit/{{$row->id}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/layanan/delete/{{$row->id}}" style="text-decoration: none;">
