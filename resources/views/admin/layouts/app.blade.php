	...
	<body>
		...
		<div class="pre-loader">
			<div class="pre-loader-box">
				<div class="loader-logo">
					<img src="{{url('assets-admin')}}/vendors/images/dpmptsp.svg" alt="" />
				</div>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="/">
					<img src="{{url('assets-admin')}}/vendors/images/dpmptsp.svg" alt="" class="dark-logo" />
					<img
						src="{{url('assets-admin')}}/vendors/images/dpmptsp-white.svg"
						alt=""
						class="light-logo"
					/>
				</a>
		...
		<div class="main-container">
			<div class="pd-ltr-20">
				...
				<div class="footer-wrap pd-20 mb-20 card-box">
					DPMPTSP - Copyright © {{date('Y')}}
					<a href="/" style="text-decoration: none" target="_blank"
						>Kota Padang Panjang</a
					>
				</div>
			</div>
		</div>
