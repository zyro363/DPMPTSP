...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-list"></i> List Data Banner</h2>
         </div>
         <div class="pull-right">
            <a href="/admin/banner/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
         </div>
      </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/banner/delete/{{$row->id}}" style="text-decoration: none;">
