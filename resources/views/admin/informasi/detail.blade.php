...
<div class="min-height-200px">
   <div class="pd-20 card-box mb-30">
      <h3 class="text-primary">Detail Informasi</h3>
      <hr>
      <div class="row">
         <div class="col-md-8">
      ...
      <div class="text-right mt-3">
         <a href="/admin/informasi" class="btn btn-secondary">Kembali</a>
         <a href="/admin/informasi/edit/{{ $item->id }}" class="btn btn-primary">Edit</a>
      </div>
   </div>
</div>
@endsection
