            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" width="20%">
                        <a href="/admin/berita/detail/{{$row->id}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                        <a href="/admin/berita/edit/{{$row->id}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <a href="/admin/berita/delete/{{$row->id}}" style="text-decoration: none;">
