...
<div class="min-height-200px">
   <div class="pd-20 card-box mb-30">
      <form action="/admin/pengumuman/update/{{ $item->id }}" method="POST" enctype="multipart/form-data">
         @csrf
         <div class="form-group">
            <label>Tanggal</label>
            <input type="date" name="tanggal" class="form-control" value="{{ isset($item->tanggal) ? date('Y-m-d', strtotime($item->tanggal)) : '' }}">
         </div>
         <div class="form-group">
            <label>Judul</label>
