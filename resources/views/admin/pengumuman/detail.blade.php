...
<div class="min-height-200px">
   <div class="pd-20 card-box mb-30">
      <h3 class="text-primary">Detail pengumuman</h3>
      <hr>
      <div class="row">
         <div class="col-md-8">
            ...
            <div class="form-group">
               ...
               <div class="form-control" style="height:auto; min-height:120px; white-space:normal">{!! $item->deskripsi !!}</div>
            </div>
         </div>
         <div class="col-md-4">
            <label>Foto</label>
      ...
      <div class="text-right mt-3">
         ...
         <a href="/admin/pengumuman/edit/{{ $item->id }}" class="btn btn-primary">Edit</a>
      </div>
   </div>
</div>
@endsection
